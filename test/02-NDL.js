...
describe("NDL", function () {
    ...
    it("contract", async function () {
        ...
        const Token = await ethers.getContractFactory("NDLToken");
        ...
        const ownerbalance = await hardhatToken.balanceOf(await owner.getAddress());
        const addr1balance = await hardhatToken.balanceOf(await addr1.getAddress());
        console.log("owner的token数量="+ownerbalance);
        console.log("地址1的token数量="+addr1balance);
