...
library PercentageMath {
  ...
  uint256 constant ONE_PERCENT = 1e4; //100, 1%
  uint256 constant TEN_PERCENT = 1e5; //1000, 10%
  uint256 constant ONE_THOUSANDTH_PERCENT = 1e3; //10, 0.1%
  uint256 constant ONE_TEN_THOUSANDTH_PERCENT = 1e2; //1, 0.01%
